...
- [Matplotlib 여러 개의 그래프 그리기](#matplotlib-여러-개의-그래프-그리기)
  - [Matplotlib 컬러맵 설정하기](#matplotlib-컬러맵-설정하기)
  - [컬러바 나타내기](#컬러바-나타내기)
  - [컬러맵 종류](#컬러맵-종류)
- [Matplotlib 텍스트 삽입하기](#matplotlib-텍스트-삽입하기)
- [Matplotlib 수학적 표현 사용하기](#matplotlib-수학적-표현-사용하기)
  - [그리스 문자 (Greek Letter)](#그리스-문자-greek-letter)
  - [위 첨자 (Superscripts), 아래 첨자 (Subscripts)](#위-첨자-superscripts-아래-첨자-subscripts)
  - [분수 (Fractions)](#분수-fractions)
  - [표준 함수 (Standard Functions)와 대형 기호 (Big Symbols)](#표준-함수-standard-functions와-대형-기호-big-symbols)
- [Matplotlib 이미지 저장하기](#matplotlib-이미지-저장하기)
  - [dpi 설정하기](#dpi-설정하기)
  - [facecolor 설정하기](#facecolor-설정하기)
  - [bbox_inches 설정하기](#bbox_inches-설정하기)
  - [pad_inches 설정하기](#pad_inches-설정하기)
- [Matplotlib 객체 지향 인터페이스](#matplotlib-객체-지향-인터페이스)
  - [plt.subplots() 사용하기](#pltsubplots-사용하기)
  - [행과 열 설정하기 (nrows, ncols)](#행과-열-설정하기-nrows-ncols)
  - [X, Y축 공유하기 (sharex, sharey)](#x-y축-공유하기-sharex-sharey)
  - [그래프 그리기](#그래프-그리기)
  - [스타일 설정하기](#스타일-설정하기)
  - [제목과 범례 표시하기](#제목과-범례-표시하기)
- [Matplotlib 두 종류의 그래프 그리기](#matplotlib-두-종류의-그래프-그리기)
  - [그래프 순서 지정하기](#그래프-순서-지정하기)
- [Matplotlib 애니메이션 사용하기](#matplotlib-애니메이션-사용하기)
  - [프레임 간격 설정하기](#프레임-간격-설정하기)
  - [애니메이션 저장하기](#애니메이션-저장하기)
  - [ArtistAnimation](#artistanimation)
  - [애니메이션 저장하기](#애니메이션-저장하기-1)
- [Matplotlib 3차원 Surface 표현하기](#matplotlib-3차원-surface-표현하기)
  - [축 눈금 지정하기](#축-눈금-지정하기)
  - [컬러맵, 컬러바 사용하기](#컬러맵-컬러바-사용하기)
